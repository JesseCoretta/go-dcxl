...
to the receiver's R_AddlId field. Note that if a slice is passed
as X, the destination value will be clobbered.
*/
...
/*
SetCurrentAuthority appends one or more string slice values to the
receiver's R_CAuthyDN field. Note that if a slice is passed as X,
...
to the receiver's R_FAuthyDN field. Note that if a slice is
...
/*
SetSponsor appends one or more string slice DN values to
the receiver's R_SAuthyDN field. Note that if a slice is
passed as X, the destination value will be clobbered.
*/
...
to the receiver's R_DiscloseTo field. Note that if a slice
is passed as X, the destination value will be clobbered.
*/
...
/*
SetIRI appends one or more string slice DN values to the
receiver's R_IRI field.  Note that if a slice is passed
as X, the destination value will be clobbered.
*/
...
/*
SetUnicodeValue appends one or more string slice DN values to
the receiver's R_UVal field. Note that if a slice is passed as
X, the destination value will be clobbered.
*/
...
receiver's R_Info field. Note that if a slice is passed
as X, the destination value will be clobbered.
*/
...
receiver's R_StdNF field. Note that if a slice is passed as X,
the destination value will be clobbered.
*/
...
receiver's R_URI field. Note that if a slice is passed
as X, the destination value will be clobbered.
*/
...
receiver's R_LongArc field. Note that if a slice is passed
as X, the destination value will be clobbered.
*/
...
/*
FrozenGetFunc processes the R_Frozen field through the provided
GetOrSetFunc instance, returning an interface value alongside
an error.
*/
...
/*
SetSubArc appends one or more string DN values to the
receiver's R_SubArc field. Note that if a slice is
passed as X, the destination value will be clobbered.
*/
...
to declare what kind of objectClass the Registration receiver describes.
*/
...
value to the receiver's R_Modified field. Note that if a slice is passed as
X, the destination value will be clobbered.
*/
...
R_URI field. Note that if a slice is passed as X, the destination
