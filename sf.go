...
/*
sf.go contains stock SetFunc-qualified functions for use during
composition of Registration and/or Registrant type instances, as
well as to offer practical examples for use in the creation of
any custom SetFunc instances by the user.
*/
